        ...
        {   
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if (empty($data['emp_no'])) {
                    ...
                    // Check emp #
                    if($this->userModel->findUserByEmpNo($data['emp_no'])){
                ...
                if (empty($data['emp_no_err']) && empty($data['email_err']) && empty($data['name_err']) && empty($data['password_err']) && empty($data['confirm_password_err'])) {
                    // Validated
